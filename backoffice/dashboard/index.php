<!DOCTYPE html>
<html lang="en">
<?php include '../common/head_two.php'; ?>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="../../admin/dashboard/index.html" class="site_title"><i class="fa fa-paw"></i> <span>Gentelella Alela!</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../../admin/dashboard/images/img.jpg" alt="..." class="img-circle profile_img">
              </div>
 ...
 <?php include '../common/sidebar_menu.php'; ?>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="../../admin/dashboard/login.html">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../../admin/dashboard/images/img.jpg" alt="">John Doe
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="../../admin/dashboard/login.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="../../admin/dashboard/images/img.jpg" alt="Profile Image" /></span>
                        <span>
        ...
        <!-- /page content -->
<?php include'../../admin/common/footr.php';?>?>
      </div>
    </div>
